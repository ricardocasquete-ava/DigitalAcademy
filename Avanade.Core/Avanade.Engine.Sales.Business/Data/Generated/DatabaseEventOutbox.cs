...
namespace Avanade.Engine.Sales.Business.Data
{
    /// <summary>
    ...
    public class DatabaseEventOutbox : DatabaseEventOutboxBase
    {
        ...
        /// </summary>
        public DatabaseEventOutbox() : base("[Sales].[spEventOutboxEnqueue]", "[Sales].[spEventOutboxDequeue]", "[Sales].[udtEventOutboxList]") { }
    }
