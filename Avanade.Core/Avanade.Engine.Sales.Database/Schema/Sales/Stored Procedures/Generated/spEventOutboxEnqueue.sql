CREATE PROCEDURE [Sales].[spEventOutboxEnqueue]
  @EventList AS [Sales].[udtEventOutboxList] READONLY
AS
BEGIN
  /*
  ...
  BEGIN TRY
    ...
    BEGIN
        ...
        INSERT INTO [Sales].[EventOutbox] ([EnqueuedDate])
        ...
        INSERT INTO [Sales].[EventOutboxData] (
          [EventOutboxId],
          [EventId],
          [Subject], 
          [Action], 
